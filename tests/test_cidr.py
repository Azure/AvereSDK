...
class cidr_test(tests.vFXTTestCase.Base):
    ...
    def test_expand_address_range(self):
        self.assertTrue(self.cmp(Cidr.expand_address_range('10.1.1.1', '10.1.1.3'), ['10.1.1.1', '10.1.1.2', '10.1.1.3']) == 0)
        self.assertFalse(self.cmp(Cidr.expand_address_range('10.1.1.1', '10.1.1.7'), ['10.1.1.1', '10.1.1.2', '10.1.1.3']) == 0)
        self.assertRaises(ValueError, Cidr.expand_address_range, '10.1.1.1', 'bad')
        self.assertTrue(self.cmp(Cidr.expand_address_range('10.1.1.1', '10.1.0.3'), []) == 0)
    ...
    def test_available(self):
        ...
        self.assertTrue(self.cmp(c.available(count=5, used=used), ['10.1.1.201', '10.1.1.202', '10.1.1.203', '10.1.1.204', '10.1.1.205']) == 0)
        self.assertTrue(self.cmp(c.available(count=3, used=used, contiguous=False), ['10.1.1.197', '10.1.1.198', '10.1.1.199']) == 0)
